...
/** SHR using the v1 per-limb helper algorithm on the v2 long[] stack. */
public class ShrOperationV1OnV2 extends AbstractFixedCostOperationV2 {

  static final OperationResult shrSuccess = new OperationResult(3, null);

  public ShrOperationV1OnV2(final GasCalculator gasCalculator) {
  ...
  public static OperationResult staticOperation(final MessageFrame frame, final long[] s) {
    ...
    frame.setTopV2(StackArithmetic.shrV1(s, frame.stackTopV2()));
    return shrSuccess;
  }
}
