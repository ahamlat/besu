...
/** SAR using the v1 per-limb helper algorithm on the v2 long[] stack. */
public class SarOperationV1OnV2 extends AbstractFixedCostOperationV2 {

  static final OperationResult sarSuccess = new OperationResult(3, null);

  public SarOperationV1OnV2(final GasCalculator gasCalculator) {
  ...
  public static OperationResult staticOperation(final MessageFrame frame, final long[] s) {
    ...
    frame.setTopV2(StackArithmetic.sarV1(s, frame.stackTopV2()));
    return sarSuccess;
  }
}
