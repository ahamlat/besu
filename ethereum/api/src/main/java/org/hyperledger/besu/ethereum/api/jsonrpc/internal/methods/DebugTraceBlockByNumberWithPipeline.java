...
public class DebugTraceBlockByNumberWithPipeline extends AbstractBlockParameterMethod {

  protected final ProtocolSchedule protocolSchedule;
  private final LabelledMetric<Counter> outputCounter;


    public DebugTraceBlockByNumberWithPipeline(final ProtocolSchedule protocolSchedule, final BlockchainQueries blockchainQueries, final ObservableMetricsSystem metricsSystem) {
  ...
  public String getName() {
    return RpcMethod.DEBUG_TRACE_BLOCK_BY_NUMBER_WITH_PIPELINE.getMethodName();
  }
  ...
  protected Object resultByBlockNumber(
    ...
    Optional<Block> maybeBlock = getBlockchainQueries()
              .getBlockchain()
        ...
        .flatMap(
            block ->
                Tracer.processTracing(
                    ...
                    traceableState -> {
                        Collection<DebugTraceTransactionResult> tracesList = new CopyOnWriteArrayList<>();
                        ...
                        Pipeline<TransactionTrace> traceBlockPipeline =
                                createPipelineFrom(
                                        ...
                                        .thenProcessAsyncOrdered("debugTraceTransactionStep", debugTraceTransactionStep, 4)
